...
base_path = os.sep.join(os.getcwd().split(os.sep))
# base_path = f'{base_path}/automate_report/digitalskola/automate_report'
...
input_file = base_path + '/input_data/supermarket_sales.xlsx'
output_file = base_path + f'/output_data/report_penjualan_{thn}.xlsx'
...
if __name__ == "__main__":
    automate.main()
    send_to_discord(webhook_url, output_file,thn)